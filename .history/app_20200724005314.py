...
def welcome():
    ...
    return (
        ...
        f" <img width='400' src='https://www.surfertoday.com/images/stories/surfingsport.jpg'/ >"
        ...
        f"<h2>Here you can get the hyperlinkedroutes list click the link to see the pages:</h2>"
